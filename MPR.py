...
class MPRWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(r"C:\Users\menna\Downloads\mri.png"))
    ...
    def create_toolbar(self):
        ...
        upload_action = QAction(QIcon(r"C:\Users\menna\Downloads\folder.png"), "Upload DICOM", self)
        ...
        mouse_controls_action = QAction(QIcon(r"C:\Users\menna\Downloads\1787045-removebg-preview.png"), "Pan: Shift+Hold and Drag\nZoom In/Out: Scroll through the image\nRotate: CTRL+Hold and Rotate\nBrightness and Contrast: Hold and Scroll", self)
